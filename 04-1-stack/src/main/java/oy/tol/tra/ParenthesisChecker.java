 ...
 * match.
 * <p>
 * Students, implement the checkParentheses() method using your StackImplementation
        ...
        for (int i = 0; i < fromString.length(); i++) {
            ...
            if (c == '(' || c == '[' || c == '{') {
                try {
                    ...
                    throw new ParenthesesException("Stack push failed", ParenthesesException.STACK_FAILURE);
                }
                count++;
            } else if (c == ')' || c == ']' || c == '}') {
                Character popped;
                ...
                if (c == ')' && popped != '(' || c == ']' && popped != '[' || c == '}' && popped != '{') {
                    throw new ParenthesesException("Paretheses were in the wrong order", ParenthesesException.PARENTHESES_IN_WRONG_ORDER);
                }
                count++;
            }
        }
